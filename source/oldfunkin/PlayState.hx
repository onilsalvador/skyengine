...
class PlayState extends FlxTransitionableState
{
	...
	public static var curLevel:String = 'Fresh';
	...
	override public function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic('oldfunkin/images/stageback.png');
		...
		var stageFront:FlxSprite = new FlxSprite(-650, 600).loadGraphic('oldfunkin/images/stagefront.png');
		...
		var stageCurtains:FlxSprite = new FlxSprite(-500, -300).loadGraphic('oldfunkin/images/stagecurtains.png');
		...
		new FlxTimer().start(Conductor.crochet / 1000, function(tmr:FlxTimer)
		{
			...
			{
				case 0:
					FlxG.sound.play('oldfunkin/sounds/intro3.ogg', 0.6);
				case 1:
					var ready:FlxSprite = new FlxSprite().loadGraphic('oldfunkin/images/ready.png');
					...
					FlxG.sound.play('oldfunkin/sounds/intro2.ogg', 0.6);
				case 2:
					var set:FlxSprite = new FlxSprite().loadGraphic('oldfunkin/images/set.png');
					...
					FlxG.sound.play('oldfunkin/sounds/intro1.ogg', 0.6);
				case 3:
					var go:FlxSprite = new FlxSprite().loadGraphic('oldfunkin/images/go.png');
					go.scrollFactor.set();
					go.screenCenter();
					add(go);
					...
					FlxG.sound.play('oldfunkin/sounds/introGo.ogg', 0.6);
				case 4:
			}
		...
		healthBarBG = new FlxSprite(0, FlxG.height * 0.9).loadGraphic('oldfunkin/images/healthBar.png');
		...
		var headTex = FlxAtlasFrames.fromSparrow('oldfunkin/images/healthHeads.png', 'oldfunkin/images/healthHeads.xml');
	...
	{
		countingDown = false;
		FlxG.sound.playMusic("oldfunkin/music/" + curLevel + "_Inst.ogg");
		vocals.play();
	}
	...
	private function generateSong(dataPath:String):Void
	{
		...
		trace('test1');
		var rawJson = File.getContent('oldfunkin/data/' + dataPath + '/' + dataPath + '.json');
		var songData = cast Json.parse(rawJson);
		trace('test1');
		Conductor.changeBPM(songData.bpm);

		curSong = songData.song;
		trace('test1');
		vocals = new FlxSound().loadEmbedded("oldfunkin/music/" + curSong + "_Voices.ogg");
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...4)
		{
			...
			var arrTex = FlxAtlasFrames.fromSparrow('oldfunkin/images/NOTE_assets.png', 'oldfunkin/images/NOTE_assets.xml');
	...
	private function popUpScore():Void
	{
		...
		if (combo > 60)
			...
			daRating = 'bad';
		rating.loadGraphic('oldfunkin/images/' + daRating + ".png");
		rating.screenCenter();
		...
		var comboSpr:FlxSprite = new FlxSprite().loadGraphic('oldfunkin/images/combo.png');
		...
		{
			var numScore:FlxSprite = new FlxSprite().loadGraphic('oldfunkin/images/num' + Std.int(i) + '.png');
	...
	function noteMiss(direction:Int = 1):Void
	{
		if (!boyfriend.stunned)
		{
			...
			FlxG.sound.play('oldfunkin/sounds/missnote' + FlxG.random.int(1, 3) + ".ogg", FlxG.random.float(0.05, 0.2));
	...
	private function everyBeat():Void
	{
			...
			|| Conductor.songPosition < lastBeat + Conductor.safeZoneOffset)
		{
			if (Conductor.songPosition > lastBeat + Conductor.crochet)
			{
				...
				trace('hey look at this please' + curSection);
