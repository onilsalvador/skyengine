...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Change Window Icon And Title', "Sets the title of the window \nand the icon of the window\nvalue 1 is for the title\nvalue 2 is for the icon"],
		['Set Original Title And Icon', "Sets the title and the icon\n to their original state"],
		...
		['Temporal Trail', 'Activate a (probably temporal) trail \nValue 1 is for the character \n 0 bf, 1 dad and 2 gf']
	];
